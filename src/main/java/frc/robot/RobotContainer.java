...
public class RobotContainer {
  ...
  public PathPlannerTrajectory leftPath(){
    return PathPlanner.generatePath(
      new PathConstraints(Constants.RobotInfo.Auton.maxSpeed*.25, Constants.RobotInfo.Auton.maxAcceleration), 
      new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),
      new PathPoint(new Translation2d(-0.1,0.23 ), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0))//-3,-0.5
      , new PathPoint(new Translation2d(-1.5,0 ), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0))//-2,0
      );
  }
  public PathPlannerTrajectory rightPath(){
    return PathPlanner.generatePath(
      ...
      new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0)),
      new PathPoint(new Translation2d(-0.1,-0.23 ), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0))//-3,-0.5
      , new PathPoint(new Translation2d(-1.5,0 ), Rotation2d.fromDegrees(0), Rotation2d.fromDegrees(0))
      );
  }
