    ...
    if (Constants.LEDInfo.LEDStatus != 0) {
      for (var i = 0; i < m_LedBuffer.getLength(); i++) {
        if (Constants.LEDInfo.LEDStatus == 1) {
          m_LedBuffer.setRGB(i, Constants.LEDInfo.GreenR, Constants.LEDInfo.GreenG, Constants.LEDInfo.GreenB);
        } else if (Constants.LEDInfo.LEDStatus == 2) {
          m_LedBuffer.setRGB(i, Constants.LEDInfo.PurpleR, Constants.LEDInfo.PurpleG, Constants.LEDInfo.PurpleB);
        } else if (Constants.LEDInfo.LEDStatus == 3) {
          m_LedBuffer.setRGB(i, Constants.LEDInfo.YellowR, Constants.LEDInfo.YellowG, Constants.LEDInfo.YellowB);
        } else if (Constants.LEDInfo.LEDStatus == 4) {
          m_LedBuffer.setRGB(i, Constants.LEDInfo.RedR, Constants.LEDInfo.RedG, Constants.LEDInfo.RedB);
        }
      }
    } else {
      boolean blue = false;
      ...
      for (var i = 0; i < m_LedBuffer.getLength(); i++) {
        ...
        if (blue) {
          m_LedBuffer.setRGB((starterLED + i) % 60, Constants.LEDInfo.BlueR, Constants.LEDInfo.BlueG,
              Constants.LEDInfo.BlueB);
        } else {
          m_LedBuffer.setRGB((starterLED + i) % 60, Constants.LEDInfo.OrangeR, Constants.LEDInfo.OrangeG,
              Constants.LEDInfo.OrangeB);
        }
      }
      starterLED++;
    }
