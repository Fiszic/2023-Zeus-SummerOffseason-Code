...
public class SwerveCommand extends CommandBase{
    ...
    public void execute(){
        ...
        if(oi.getButton(0, Constants.ControllerConstants.Buttons.X_BUTTON).getAsBoolean()){
        ...
        else if(oi.getButton(0, Constants.ControllerConstants.Buttons.Y_BUTTON).getAsBoolean()){
        ...
        else if(oi.getButton(0, Constants.ControllerConstants.Buttons.B_BUTTON).getAsBoolean()){
            ...
            double turningSpeed;
        // if(Constants.activeVariables.isRed){
            xSpeed = oi.getAxis(0, Constants.ControllerConstants.Axes.LEFT_STICK_X)*1;
            ySpeed = -oi.getAxis(0, Constants.ControllerConstants.Axes.LEFT_STICK_Y)*.6;
        ...
        xSpeed = xLimiter.calculate(xSpeed)*Constants.RobotInfo.MAX_ROBOT_SPEED;
        ySpeed = yLimiter.calculate(ySpeed)*Constants.RobotInfo.MAX_ROBOT_SPEED;
        // xSpeed*=Constants.RobotInfo.MAX_ROBOT_SPEED;
        // ySpeed*=Constants.RobotInfo.MAX_ROBOT_SPEED;
        turningSpeed = turningSpeed*Constants.RobotInfo.MAX_ROBOT_SPEED;
